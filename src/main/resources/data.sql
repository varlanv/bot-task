INSERT INTO task.departments (id, name)
VALUES (1,'History'),
       (2,'Art'),
       (3,'Chemistry'),
       (4,'Technology'),
...
INSERT INTO task.degrees (id, title)
VALUES (1,'assistant'),
       (2,'associate professor'),
       (3,'professor');

INSERT INTO task.lectors (first_name, last_name, degree_id, salary, head_of_department)
VALUES ('Richard', 'Stallman', 2, 12500, false),
       ('Doug', 'Lea', 3, 14300, true),
       ('Richard', 'Dawkings', 3, 10000, true),
       ('William', 'Hamilton', 2, 9000, false),
       ('Ian', 'Morris', 1, 8000, true),
...
INSERT INTO task.lectors_departments (lector_id, department_id)
VALUES (1, 4),
       (2, 4),
       (3, 5),
       (4, 2),
